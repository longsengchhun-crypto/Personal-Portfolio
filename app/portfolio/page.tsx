...
export const metadata = pageMetadata("/portfolio/", "Work", "Browse creative work across graphic design, poster design, video editing, photography, and 3D by LONG SENGCHHUN.");
