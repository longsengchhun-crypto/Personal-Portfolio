  ...
  return <footer className="site-footer"><div className="container">
    <div className="footer-grid">
      ...
      <div className="footer-contact">
        ...
        <div className="socials">{social.map((link) => <a href={link.url} target="_blank" rel="noreferrer" aria-label={link.label} key={link.id}>{link.icon_name ? <i className={`bi bi-${link.icon_name}`} /> : link.label}</a>)}</div>
      </div>
    </div>
